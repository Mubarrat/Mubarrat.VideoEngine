...
public unsafe class H264VaapiNv12Encoder : VideoEncoder
{
    public static readonly EncoderConstructor Constructor = (w, h, fps, path) => new H264VaapiNv12Encoder(w, h, fps, path);

    private readonly AVFrame* frameBgra;
    private readonly AVFrame* frameNv12;
    private readonly SwsContext* swsCtx;

    public H264VaapiNv12Encoder(ushort width, ushort height, ushort fps, string outputPath)
        : base(width, height, fps, outputPath, "h264_vaapi", AVPixelFormat.AV_PIX_FMT_NV12)
    {
