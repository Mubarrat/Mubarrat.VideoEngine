...
public unsafe class H264NvencNv12Encoder : VideoEncoder
{
    public static readonly EncoderConstructor Constructor = (w, h, fps, path) => new H264NvencNv12Encoder(w, h, fps, path);

    private readonly AVFrame* frameBgra;
    private readonly AVFrame* frameNv12;
    private readonly SwsContext* swsCtx;

    public H264NvencNv12Encoder(ushort width, ushort height, ushort fps, string outputPath)
        : base(width, height, fps, outputPath, "h264_nvenc", AVPixelFormat.AV_PIX_FMT_NV12)
    {
