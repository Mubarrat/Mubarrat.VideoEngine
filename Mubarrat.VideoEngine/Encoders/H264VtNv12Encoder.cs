...
public unsafe class H264VtNv12Encoder : VideoEncoder
{
    public static readonly EncoderConstructor Constructor = (w, h, fps, path) => new H264VtNv12Encoder(w, h, fps, path);

    private readonly AVFrame* frameBgra;
    private readonly AVFrame* frameNv12;
    private readonly SwsContext* swsCtx;

    public H264VtNv12Encoder(ushort width, ushort height, ushort fps, string outputPath)
        : base(width, height, fps, outputPath, "h264_videotoolbox", AVPixelFormat.AV_PIX_FMT_NV12)
    {
